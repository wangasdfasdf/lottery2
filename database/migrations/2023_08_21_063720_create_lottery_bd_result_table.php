...
return new class extends Migration
{
    ...
    {
       $this->schema()->create('lottery_bd_result', function (Blueprint $table) {
           $table->id();
       ...
       DB::statement("ALTER TABLE `lottery_bd_result` comment '北单开奖结果'");
    }
    ...
    {
        $this->schema()->dropIfExists('lottery_bd_result');
    }
};
